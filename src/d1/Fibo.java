...
// 피보나치 알고리즘을 이터레이션 vs 재귀를 비교
public class Fibo {
    int count = 0;


    // 1. 이터레이션 (어래이를  만들지 않아도 됨, 변수를 선언해서 계속 재할당해도 됨)
    ...
    public static void main(String[] args) {
        ...
        f.resetCount();
        System.out.println("Iteration :"+f.iteration(20));
        System.out.println("Iteration cnt :" +f.getCount());

        f.resetCount();
        System.out.println("Recursion :"+f.rec(20));
        System.out.println("Recursion cnt :"+f.getCount());
